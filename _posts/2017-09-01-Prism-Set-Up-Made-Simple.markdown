...
<a href="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/FileNewProject/FileNewProject.png"><img style="width:100%" src="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/FileNewProject/FileNewProject.png"></a>

And as our <b>Coding Sharing Strategy</b> choose PCL for this tutorial.

<a href="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/FileNewProject/AfterFileNew.png"> <img style="width:100%" src="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/FileNewProject/AfterFileNew.png"></a>

Run the project to make sure this <b>File New</b> kinda thing at least works. Lol (because sometimes it doesn't.)

<a href="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/FileNewProject/AppRunningAfterNewFileAndroid.png"> <img style="width:50%" src="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/FileNewProject/AppRunningAfterNewFileAndroid.png">
</a>
...
<a href="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/FileNewProject/InstallingPrismInAllProjects.png"> <img style="width:100%" src="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/FileNewProject/InstallingPrismInAllProjects.png">
</a>

<a href="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/FileNewProject/PrismUnity.png"><img style="width:100%" src="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/FileNewProject/PrismUnity.png"></a>
...
<img style="width:100%" src="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/PCLInit/BeforeAppcs.png">
</a>
...
<img style="width:100%" src="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/PCLInit/AfterSettingPrismApplication.png">
</a>
...
<img style="width:100%" src="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/PCLInit/BeforeAppXAML.png">
</a>
...
<img style="width:100%" src="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/PCLInit/AppXAMLAfter.png">
</a>
...
<a href="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/AndroidInitialization/MainActivitySetupBefore.png"><img style="width:120%; height:200%" src="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/AndroidInitialization/MainActivitySetupBefore.png">
</a>
...
<a href="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/iOSInit/AppDelegateBefore.png"><img style="width:120%; height:200%" src="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/iOSInit/AppDelegateBefore.png">
</a>
...
<a href="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/RestructuringSolution/1.png"><img style="width:100%;" src="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/RestructuringSolution/1.png">
</a>

So open the file <b>Section1Page.xaml</b> you just created and add a button to the layout.

<a href="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/RestructuringSolution/2.png"><img style="width:120%;" src="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/RestructuringSolution/2.png">
</a>
...
<a href="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/RestructuringSolution/3.png"><img style="width:120%;" src="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/RestructuringSolution/3.png">
</a>

Now let's do the same with our <b>Section2Page.xaml</b> file.

<a href="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/RestructuringSolution/4.png"><img style="width:120%;" src="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/RestructuringSolution/4.png">
</a>

Now, we are gonna set up our viewmodels, open the file <b>Section1PageViewModel.cs</b> we created a few minutes ago.

<a href="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/RestructuringSolution/6.png"><img style="width:120%;" src="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/RestructuringSolution/6.png">
</a>
...
<a href="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/RestructuringSolution/7.png"><img style="width:120%;" src="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/RestructuringSolution/7.png">
</a>
...
<a href="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/RestructuringSolution/InstallingFodyAfterViewModelBase.png"><img style="width:120%;" src="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/RestructuringSolution/InstallingFodyAfterViewModelBase.png">
</a>

So now let's go back to our <b>Section1PageViewModel.cs</b> file and add a <b>Command</b> property.

<a href="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/RestructuringSolution/10.png"><img style="width:120%;" src="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/RestructuringSolution/10.png">
</a>
...
<a href="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/RestructuringSolution/11.png"><img style="width:120%;" src="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/RestructuringSolution/11.png">
</a>
...
<a href="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/RestructuringSolution/12-1.png"><img style="width:120%;" src="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/RestructuringSolution/12-1.png">
</a>
...
<a href="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/RestructuringSolution/12.png"><img style="width:120%;" src="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/RestructuringSolution/12.png">
</a>

And now to finish all these, we need to register these screens we created so we can navigate to them.

<a href="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/RestructuringSolution/13.png"><img style="width:120%;" src="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/RestructuringSolution/13.png">
</a>
...
<a href="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/Ran/NavigationSampleRunning.gif"><img src="{{ site.github.url | replace: 'http://', '//' }}/assets/img/2017-09-01-assets/Ran/NavigationSampleRunning.gif">
</a>
